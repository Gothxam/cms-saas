...
<div class="max-w-2xl mx-auto space-y-8">
    <header>
        <a href="appointments.php" class="inline-flex items-center gap-2 text-slate-500 hover:text-teal-600 font-bold text-sm transition-colors mb-2">
    ...
    <form method="POST" class="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
        ...
        <div>
            ...
            <select name="patient_id" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-500/5 focus:border-teal-500 transition-all font-semibold">
        ...
        <div>
            ...
            <select name="doctor_id" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-500/5 focus:border-teal-500 transition-all font-semibold">
        ...
        <div>
            ...
            <input type="datetime-local" name="date_time" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-500/5 focus:border-teal-500 transition-all font-semibold">
        </div>

        <!-- Submit Button -->
        <div class="pt-4">
            <button type="submit" class="w-full bg-teal-600 text-white py-4 rounded-xl font-bold shadow-xl shadow-teal-600/20 hover:bg-teal-700 transition-all flex items-center justify-center gap-2">
